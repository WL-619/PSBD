"""
Code modified from https://github.com/vtu81/backdoor-toolbox/blob/main/cleansers_tool_box/scan.py
"""
...
class SCAn:
    ...
    def build_local_model(self, reprs, labels, gb_model, n_classes):
        ...
        for k in range(L):
            ...
            u1[k] = i_u1
            u2[k] = i_u2
            class_score[k] = [k, i_sc.item(), np.sum(selected_idx)]
...
def cleanser(inspection_set, model, num_classes, clean_set):
